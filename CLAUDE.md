...
# Generate grey IDR frame from external VPS/SPS/PPS (any chroma format/bit depth)
...
- `EncodeGreyIDRSliceFromSPSPPS(sps, pps)` — Grey IDR slice (any chroma format/bit depth)
